...
from utils.assembly_graph_human_baseline import AssemblyGraph
import igl
...
def annotate_functional_basis(examples,
    ...
    def add_annotation_tier1(annotation_tier1):
        ...
        if annotation_tier1 == "Metal_Steel":
            THIS_ANNOTATION.append("Metal_Ferrous_Steel")
        elif annotation_tier1 == "Non-Ferrous":
            THIS_ANNOTATION.append("Metal_Non-Ferrous")
        else:
